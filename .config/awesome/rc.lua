...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "main", "www", "chat", "office", "coding", "misc" }, s, layouts[2])
end
-- }}}
...
myeditorsmenu = {
                   { "gedit", "gedit" },
                   { "leafpad", "leafpad" },
                   { "vim", "mpd ; " .. terminal .. " -e vim --cmd \"cd Documents/\"" },
                   { "eclipse", "eclipse" }
                }

mymultimediamenu = {
                      { "VLC", "vlc" },
                      { "ncmpc++", terminal .. " -e ncmpcpp" }
                     }
...
sepline.text = "<span color=\"" .. cyan .. "\">" .. " | " .. "</span>"
...
-- Register widget
vicious.register(memwidget, vicious.widgets.mem, "<span color=\"" .. orange .. "\">" .."ram: $1% ($2MB / 4GB)".. "</span>", 13)

-- Battery
batwidget = widget({ type = "textbox" })
vicious.register(batwidget, vicious.widgets.bat, "<span color=\"" .. orange .. "\">" .."bat: $2%".. "</span>", 61, "BAT0")

-- Network usage widget
-- netwidget = widget({ type = "textbox" })
-- vicious.register(netwidget, vicious.widgets.net, "<span color=\"" .. orange .. "\">" .."down: ${wlan0 down_kb} up: ${wlan0 up_kb}".."</span", 3)
...
awful.rules.rules = {
    ...
    -- Thunar 
    { rule = { class = "Thunar" }, properties = { tag = tags[1][1], switchtotag = true} },

    -- irssi
    { rule = { name = "irssi" }, properties = { tag = tags[1][3], switchtotag = true} },
    ...
    -- Thunderbird
    { rule = { class = "Thunderbird" }, properties = { tag = tags[1][2], switchtotag = true} },

    -- Pidgin
    { rule = { class = "Pidgin" }, properties = { tag = tags[1][2], switchtotag = true } },

    -- Dropbox
    { rule = { class = "Dropbox" }, properties = { tag = tags[1][1], switchtotag = true } },

    -- Gucharmap
    { rule = { class = "Gucharmap" }, properties = { tag = tags[1][6], switchtotag = true } },

    -- Eclipse
    { rule = { class = "Eclipse" }, properties = { tag = tags[1][5], switchtotag = true} },
